...
#define GEO_DEATH_RAGDOLL_LIMB(limb) \
   GEO_ASM(limb, death_ragdoll_geo_rotate_limb), \
      ...
      GEO_OPEN_NODE(),
         ...
         GEO_OPEN_NODE(),
            ...
            GEO_OPEN_NODE(),
	               ...
	               GEO_OPEN_NODE(),
	                  GEO_DEATH_RAGDOLL_LIMB(DEATH_RAGDOLL_LIMB_HEAD),
...
const GeoLayout mario_geo[] = {
   ...
   GEO_OPEN_NODE(),
      GEO_SWITCH_CASE(2, death_ragdoll_geo_switch_visual),
      GEO_OPEN_NODE(),
         GEO_NODE_START(),
         GEO_OPEN_NODE(),
            ...
            GEO_CLOSE_NODE(),
         GEO_CLOSE_NODE(),
         GEO_ASM(0, death_ragdoll_geo_render),
      GEO_CLOSE_NODE(),
   GEO_CLOSE_NODE(),
   GEO_END(),
};
