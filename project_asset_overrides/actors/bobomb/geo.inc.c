...
const GeoLayout black_bobomb_geo[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         ...
         GEO_OPEN_NODE(),
GEO_ANIMATED_PART(LAYER_OPAQUE, 0, -25, 0, NULL),
             GEO_OPEN_NODE(),
GEO_ANIMATED_PART(LAYER_OPAQUE, 0, 10, 0, NULL),
                  GEO_OPEN_NODE(),
                      GEO_DISPLAY_LIST(LAYER_OPAQUE, bobomb_body_sphere_dl_black),
                  GEO_CLOSE_NODE(),
...
GEO_ANIMATED_PART(LAYER_OPAQUE, 0, 10, 0, NULL),
                  GEO_OPEN_NODE(),
                      GEO_DISPLAY_LIST(LAYER_OPAQUE, bobomb_body_sphere_dl),
                GEO_CLOSE_NODE(),
               GEO_ANIMATED_PART(LAYER_OPAQUE, 0, 57, -60, NULL),
               GEO_OPEN_NODE(),
                  GEO_ANIMATED_PART(LAYER_OPAQUE, 0, 0, 0, NULL),
