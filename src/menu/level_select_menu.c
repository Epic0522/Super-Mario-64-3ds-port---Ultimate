...
#ifdef TARGET_N3DS
s16 gN3dsIntroScreenMode = 0;
s16 gN3dsIntroScreenExiting = FALSE;
u32 gN3dsIntroScreenFadeStart = 0;
#endif
...
#ifdef TARGET_N3DS
    if (arg1 != 0 && retVar != 0 && gN3dsIntroScreenExiting == FALSE) {
        gN3dsIntroScreenExiting = TRUE;
        gN3dsIntroScreenFadeStart = gGlobalTimer;
    }
#endif
