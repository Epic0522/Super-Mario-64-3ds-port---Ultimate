...
const struct MiniMapInfo level_bbh[] = {
    {bbh_t3x, bbh_t3x_size, 0x000000, false},
};
...
const struct MiniMapInfo level_ssl[] = {
    {ssl_1_t3x, ssl_1_t3x_size, 0x000000, false},
    {ssl_2_t3x, ssl_2_t3x_size, 0x000000, true},
    {ssl_3_t3x, ssl_3_t3x_size, 0x000000, true},
};
const struct MiniMapInfo level_bob[] = {
    {bob_t3x, bob_t3x_size, 0x0cae1f, false},
};
const struct MiniMapInfo level_sl[] = {
    {sl_1_t3x, sl_1_t3x_size, 0x000000, false},
    {sl_2_t3x, sl_2_t3x_size, 0x000000, true},
};
const struct MiniMapInfo level_wdw[] = {
    {wdw_1_t3x, wdw_1_t3x_size, 0x000000, false},
    {wdw_2_t3x, wdw_2_t3x_size, 0x000000, true},
};
...
const struct MiniMapInfo level_thi[] = {
    {thi_1_t3x, thi_1_t3x_size, 0x000000, false},
    {thi_2_t3x, thi_2_t3x_size, 0x000000, true},
    {thi_3_t3x, thi_3_t3x_size, 0x000000, true},
};
...
const struct MiniMapInfo level_castle_grounds[] = {
    {castle_grounds_t3x, castle_grounds_t3x_size, 0x0ebc00, false},
    /* drained castle grounds is not an area but a savegame flag */
    {castle_grounds_drained_t3x, castle_grounds_drained_t3x_size, 0x0ebc00, false},
};
...
const struct MiniMapInfo level_bitfs[] = {
    {bitfs_t3x, bitfs_t3x_size, 0x000000, false},
};
...
const struct MiniMapInfo level_lll[] = {
    {lll_1_t3x, lll_1_t3x_size, 0xae1d01, false},
    {lll_2_t3x, lll_2_t3x_size, 0x000000, true},
};
const struct MiniMapInfo level_ddd[] = {
    {ddd_1_t3x, ddd_1_t3x_size, 0x000000, false},
    {ddd_2_t3x, ddd_2_t3x_size, 0x000000, true},
};
const struct MiniMapInfo level_wf[] = {
    {wf_t3x, wf_t3x_size, 0x8cbdf7, false},
};
const struct MiniMapInfo level_castle_courtyard[] = {
    {castle_courtyard_t3x, castle_courtyard_t3x_size, 0x52c618, false},
};
...
const struct MiniMapInfo level_wmotr[] = {
    {wmotr_t3x, wmotr_t3x_size, 0x000000, false},
};
const struct MiniMapInfo level_bowser_2[] = {
    {bowser_2_t3x, bowser_2_t3x_size, 0x000000, false},
};
const struct MiniMapInfo level_bowser_3[] = {
    {bowser_3_t3x, bowser_3_t3x_size, 0x000000, false},
};
const struct MiniMapInfo level_ttm[] = {
    {ttm_1_t3x, ttm_1_t3x_size, 0x000000, false},
    {ttm_2_t3x, ttm_2_t3x_size, 0x000000, true},
    {ttm_3_t3x, ttm_3_t3x_size, 0x000000, true},
    {ttm_4_t3x, ttm_4_t3x_size, 0x000000, true},
};
