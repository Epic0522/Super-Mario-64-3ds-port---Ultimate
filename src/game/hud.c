...
void render_hud_timer(void) {
    ...
    switch (eu_get_language()) {
        case LANGUAGE_ENGLISH:
            print_text(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(150), timerY, "TIME");
            break;
        case LANGUAGE_FRENCH:
            print_text(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(155), timerY, "TEMPS");
            break;
        case LANGUAGE_GERMAN:
            print_text(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(150), timerY, "ZEIT");
            break;
    }
#endif
    ...
    print_text(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(150), timerY, "TIME");
#endif
    print_text_fmt_int(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(91), timerY, "%0d", timerMins);
    print_text_fmt_int(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(71), timerY, "%02d", timerSecs);
    print_text_fmt_int(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(37), timerY, "%d", timerFracSecs);
    gSPDisplayList(gDisplayListHead++, dl_hud_img_begin);
    render_hud_tex_lut(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(81), timerMarkY, (*hudLUT)[GLYPH_APOSTROPHE]);
    render_hud_tex_lut(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(46), timerMarkY, (*hudLUT)[GLYPH_DOUBLE_QUOTE]);
...
void render_hud_camera_status(void) {
...
#ifdef TARGET_N3DS
    x = GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(newcam_active ? 112 : 74);
    y = 215;
#else
    x = GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(newcam_active ? 102 : 54);
    y = 205;
#endif
    ...
    if (newcam_active) {
        freeX = x + 16;
        freeY = y;
        render_hud_tex_lut(freeX, freeY, (*hudLUT)['F' - 55]);
        render_hud_tex_lut(freeX + 12, freeY, (*hudLUT)['R' - 55]);
        render_hud_tex_lut(freeX + 24, freeY, (*hudLUT)['E' - 55]);
        render_hud_tex_lut(freeX + 36, freeY, (*hudLUT)['E' - 55]);
    }
