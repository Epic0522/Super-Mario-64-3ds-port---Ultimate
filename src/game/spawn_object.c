...
struct Object *allocate_object(struct ObjectNode *objList) {
    ...
    // Initialize 60fps interpolation state to prevent cold-start crashes
    obj->header.gfx.prevTimestamp = 0;
    obj->header.gfx.prevShadowPosTimestamp = 0;
    obj->header.gfx.prevScaleTimestamp = 0;
    obj->header.gfx.prevThrowMatrixTimestamp = 0;
    obj->header.gfx.skipInterpolationTimestamp = 0;
    obj->header.gfx.throwMatrixInterpolated = NULL;
    obj->header.gfx.unk38.prevAnimFrame = 0;
    obj->header.gfx.unk38.prevAnimID = 0;
    obj->header.gfx.unk38.prevAnimFrameTimestamp = 0;
    obj->header.gfx.unk38.prevAnimPtr = NULL;
